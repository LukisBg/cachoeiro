...
* Maven (embutido no NetBeans/IntelliJ).

### 2. Configuração do Banco de Dados
Crie um banco de dados no MySQL chamado `padaria_db` e execute o script SQL disponível no relatório técnico.
...
spring.jpa.hibernate.ddl-auto=updatee
````
